...
gazebo gazebo_worlds/worlds/mountain_tea_garden_80m.world
```
...
```bash
python3 gazebo_worlds/worlds/generate_mountain_tea_garden_80m.py
```

默认随机种子为 `20260730`。若要生成另一组茶株尺寸和岩石尺寸：

```bash
python3 gazebo_worlds/worlds/generate_mountain_tea_garden_80m.py --seed 42
```
